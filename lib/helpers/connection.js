...
const ReasonDB = require(path.resolve('./node_modules/reasondb/lib'))
const drivers = require(path.resolve('./node_modules/reasondb/lib/drivers/JSONBlockStore'))(ReasonDB)
